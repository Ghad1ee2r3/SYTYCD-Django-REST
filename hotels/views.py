...
from .serializers import HotelsListSerializer, HotelDetailsSerializer, BookHotelSerializer, BookingDetailsSerializer, PastBookingDetailsSerializer , UserSerializer, UserCreateSerializer
...
class BookHotel(CreateAPIView):
	...
	def perform_create(self, serializer):
		serializer.save(user=self.request.user, hotel_id=self.kwargs['hotel_id'])#error
